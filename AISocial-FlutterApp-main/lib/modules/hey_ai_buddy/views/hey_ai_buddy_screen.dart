import 'package:ai_social_flutter/common/resources/global_data.dart';
import 'package:ai_social_flutter/modules/ai_chat/views/ai_chat_screen.dart';
import 'package:ai_social_flutter/modules/hey_ai_buddy/view_model/hey_ai_buddy_vm.dart';
import 'package:ai_social_flutter/modules/hey_ai_buddy/views/create_hey_ai_buddy_screen.dart';
                            ...
                            builder: (context, snapshot) {
                              if (snapshot.connectionState ==
                                ...
                                return ListView.builder(
                                    ...
                                    itemCount: items!.length,
                                    itemBuilder: (_, index) {
                                      return Obx(() => controller.selectedCategoryName.value.toLowerCase()==items[index]['selectedCategory'].toString().toLowerCase()?Padding(
                                        padding: const EdgeInsets.symmetric(
                                            horizontal: 8, vertical: 5),
                                        child: GestureDetector(
                                          onTap: (){
                                            userNameGlobalData.value=items[index]['name'];
                                            Get.to(ChatWithAiCharacterScreen());
                                          },
                                          child: Container(
                                            width: 170,
                                            decoration: BoxDecoration(
